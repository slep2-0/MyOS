...
# Link kernel
build/kernel.elf: build/kernel_entry.o build/kernel.o build/idt.o build/isr.o build/handlers.o build/pfn.o build/attach.o build/pushlock.o build/synchinit.o build/wait.o build/instruction.o build/section.o build/setup.o build/handler.o build/exception.o \
