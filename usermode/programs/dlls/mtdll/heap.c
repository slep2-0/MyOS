...
/*++
    ...
    Routine description:
        ...
        Reserves a virtual-memory segment and initializes its first free block.

    Arguments:

        [IN] Heap - Heap whose metadata or allocation is being processed.
        [IN] MinimumSize - Size of the minimum in bytes.
...
/*++
    ...
    Routine description:
        ...
        Reserves and initializes a slab for one allocation-size bucket.

    Arguments:

        [IN] Heap - Heap whose metadata or allocation is being processed.
        [IN] Bucket - Slab bucket selected for the allocation size.
...
/*++
    ...
    Routine description:
        ...
        Claims one free slot from a slab allocation bitmap.

    Arguments:

        [IN] Slab - Slab containing the allocation.
...
/*++
    ...
    Routine description:
        ...
        Selects the slab bucket that can satisfy an allocation size.
...
/*++
    ...
    Routine description:
        ...
        Finds a slab with a free slot in a size bucket.

    Arguments:

        [IN] SlabBucket - Bucket that owns the slab.
...
/*++
    ...
    Routine description:
        ...
        Finds and splits a free segment block for an allocation.

    Arguments:

        [IN] Heap - Heap whose metadata or allocation is being processed.
        [IN] RequestedSize - Size of the requested in bytes.
...
/*++
    ...
    Routine description:
        ...
        Returns NULL or raises an allocation exception according to heap options.

    Arguments:

        [IN] GenerateExceptions - Whether allocation failure should raise an exception.
        [IN] FailureStatus - Failure status expected from the tested path.
...
/*++
    ...
    Routine description:
        ...
        Allocates from a slab or segment while the heap lock is held.

    Arguments:

        [IN] Heap - Heap whose metadata or allocation is being processed.
        [IN] Options - Options controlling the operation.
        [IN] AllocationSize - Size of the allocation in bytes.
        [IN] FailureStatus - Failure status expected from the tested path.
...
/*++
    ...
    Routine description:
        ...
        Validates and releases an allocation owned by a slab.
    ...
    Return Values:
        ...
        true when the slab allocation is released, or false when the address is not a valid slab allocation.
...
/*++
    ...
    Routine description:
        ...
        Validates and releases an allocation owned by a segment.
    ...
    Return Values:
        ...
        true when the segment allocation is released, or false when the address is not a valid segment allocation.
