...
Use GCC 10.3 (updated from 4.6.3, now using C11 as well from C99) (the one im using) with the latest binutils, along with EDK2 that let me use a UEFI bootloader: https://github.com/tianocore/edk2
