...
/*++
    ...
    Routine description:
        ...
        Runs the user APC used by the exception-chain stress scenario.
...
/*++
    ...
    Routine description:
        ...
        Reports a fatal failure detected by the exception-chain test suite.

    Arguments:

        [IN] Test - Test identifier used to select a failure status.
...
/*++
    ...
    Routine description:
        ...
        Evaluates the access violation exception filter.

    Arguments:

        [IN] Information - Exception information supplied to the filter.
        [IN] Expectation - Expected exception address, operation, and recovery state.
...
/*++
    ...
    Routine description:
        ...
        Runs the unhandled access violation worker entry point.
    ...
    Return Values:
        ...
        The worker exit status if execution unexpectedly continues past the tested exception.
...
/*++
    ...
    Routine description:
        ...
        Validates a delivered processor exception and selects whether to continue.
...
/*++
    ...
    Routine description:
        ...
        Runs the unhandled divide worker entry point.
...
/*++
    ...
    Routine description:
        ...
        Runs the unhandled invalid opcode worker entry point.
...
/*++
    ...
    Routine description:
        ...
        Runs the unhandled privileged worker entry point.
...
/*++
    ...
    Routine description:
        ...
        Runs the unhandled general protection worker entry point.
...
/*++
    ...
    Routine description:
        ...
        Triggers one processor exception and validates its continuation context.

    Arguments:

        [IN] CauseException - Callback that executes the faulting instruction.
        [IN] ExpectedResumeStatus - Expected resume status.
        [IN] ExpectedExceptionCode - Expected exception code.
        [IN] InstructionAddress - Expected address of the faulting instruction.
        [IN] ResumeAddress - Instruction address at which execution should resume.
        [IN] FailureBase - Base status code reserved for the tested failure group.
...
/*++
    ...
    Routine description:
        ...
        Tests delivery of a real general-protection access exception.
...
/*++
    ...
    Routine description:
        ...
        Runs the real divide, invalid-opcode, and general-protection tests.
...
/*++
    ...
    Routine description:
        ...
        Runs one processor exception in a child process and validates its fatal status.

    Arguments:

        [IN] Worker - Worker context associated with the randomized test.
        [IN] ExpectedStatus - Expected status.
        [IN] FailureBase - Base status code reserved for the tested failure group.
...
/*++
    ...
    Routine description:
        ...
        Tests fatal delivery of each supported unhandled processor exception.
...
/*++
    ...
    Routine description:
        ...
        Deliberately faults inside an exception handler to test nested fault handling.
...
/*++
    ...
    Routine description:
        ...
        Runs the handler fault worker entry point.
...
/*++
    ...
    Routine description:
        ...
        Tests termination when an exception handler itself faults.
...
/*++
    ...
    Routine description:
        ...
        Tests read, write, and execute access-violation delivery.
...
/*++
    ...
    Routine description:
        ...
        Tests termination after an unhandled access violation.
...
/*++
    ...
    Routine description:
        ...
        Records a handler visit and continues exception-chain search.
...
/*++
    ...
    Routine description:
        ...
        Requests continued exception-chain search.
...
/*++
    ...
    Routine description:
        ...
        Requests continuation at the supplied exception context.
...
/*++
    ...
    Routine description:
        ...
        Returns an invalid disposition to test dispatcher validation.
...
/*++
    ...
    Routine description:
        ...
        Returns the nested-exception disposition used by a fatal-path test.
...
/*++
    ...
    Routine description:
        ...
        Returns the collided-unwind disposition used by a fatal-path test.
...
/*++
    ...
    Routine description:
        ...
        Mutates its exception-chain successor to test saved-next traversal.
...
/*++
    ...
    Routine description:
        ...
        Records execution of the tail handler in the saved-next traversal test.
...
/*++
    ...
    Routine description:
        ...
        Handles the software exception used by the native raise-and-continue test.
...
/*++
    ...
    Routine description:
        ...
        Tests a software-raised exception that resumes through MtContinue.
...
/*++
    ...
    Routine description:
        ...
        Reports a failed language-frame state comparison.

    Arguments:

        [IN] Frame - Language or registration frame affected by the operation.
        [IN] ExceptionCode - Status code assigned to the software exception.
        [IN] Information - Exception information supplied to the filter.
        [IN] ExpectedNext - Expected next.

    Return Values:

        Zero when every field matches, or the one-based index of the first mismatch.
...
/*++
    ...
    Routine description:
        ...
        Tests normal entry and removal of a translated language frame.
...
/*++
    ...
    Routine description:
        ...
        Evaluates the translated continue exception filter.
...
/*++
    ...
    Routine description:
        ...
        Tests translated try/except syntax and filter execution.
...
/*++
    ...
    Routine description:
        ...
        Tests continuation selected by a translated language filter.
...
/*++
    ...
    Routine description:
        ...
        Tests entry into a translated language exception handler.
...
/*++
    ...
    Routine description:
        ...
        Raises an inner translated exception that continues outer-frame search.
...
/*++
    ...
    Routine description:
        ...
        Tests search from an inner translated frame to an outer frame.
...
/*++
    ...
    Routine description:
        ...
        Tests exception dispatch with an empty registration chain.
...
/*++
    ...
    Routine description:
        ...
        Tests handler visitation order across an exception chain.

    Arguments:

        [IN] FrameCount - Number of frame entries.
        [IN] FailureBase - Base status code reserved for the tested failure group.
...
/*++
    ...
    Routine description:
        ...
        Tests traversal using a successor saved before handler invocation.
...
/*++
    ...
    Routine description:
        ...
        Runs the fatal case worker entry point.
...
/*++
    ...
    Routine description:
        ...
        Tests invalid dispositions, bad frames, and other fatal dispatch cases.
...
/*++
    ...
    Routine description:
        ...
        Runs the complete user-mode exception-chain test suite.
