...
enum opt_code
{
  ...
  OPT_march_ = 958,                          /* -march= */
  OPT_masm_ = 959,                           /* -masm= */
  OPT_mavx = 960,                            /* -mavx */
  OPT_mavx256_split_unaligned_load = 961,    /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 962,   /* -mavx256-split-unaligned-store */
  OPT_mbmi = 963,                            /* -mbmi */
  ...
  OPT_mieee_fp = 982,                        /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 983,       /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 984,           /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 985,   /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 986, */             /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 987,          /* -mlarge-data-threshold= */
  OPT_mlwp = 988,                            /* -mlwp */
  OPT_mmmx = 989,                            /* -mmmx */
  OPT_mmovbe = 990,                          /* -mmovbe */
  OPT_mms_bitfields = 991,                   /* -mms-bitfields */
  OPT_mno_align_stringops = 992,             /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 993,              /* -mno-fancy-math-387 */
  OPT_mno_push_args = 994,                   /* -mno-push-args */
  OPT_mno_red_zone = 995,                    /* -mno-red-zone */
  OPT_mno_sse4 = 996,                        /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 997,        /* -momit-leaf-frame-pointer */
  OPT_mpc = 998,                             /* -mpc */
  OPT_mpclmul = 999,                         /* -mpclmul */
  OPT_mpopcnt = 1000,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1001,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1002,     /* -mpreferred-stack-boundary= */
  OPT_mpush_args = 1003,                     /* -mpush-args */
  OPT_mrdrnd = 1004,                         /* -mrdrnd */
  OPT_mrecip = 1005,                         /* -mrecip */
  OPT_mred_zone = 1006,                      /* -mred-zone */
  OPT_mregparm_ = 1007,                      /* -mregparm= */
  OPT_mrtd = 1008,                           /* -mrtd */
  OPT_msahf = 1009,                          /* -msahf */
  OPT_msoft_float = 1010,                    /* -msoft-float */
  OPT_msse = 1011,                           /* -msse */
  OPT_msse2 = 1012,                          /* -msse2 */
  OPT_msse2avx = 1013,                       /* -msse2avx */
  OPT_msse3 = 1014,                          /* -msse3 */
  OPT_msse4 = 1015,                          /* -msse4 */
  OPT_msse4_1 = 1016,                        /* -msse4.1 */
  OPT_msse4_2 = 1017,                        /* -msse4.2 */
  OPT_msse4a = 1018,                         /* -msse4a */
  /* OPT_msse5 = 1019, */                    /* -msse5 */
  OPT_msseregparm = 1020,                    /* -msseregparm */
  OPT_mssse3 = 1021,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1022,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1023,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1024,            /* -mstringop-strategy= */
  OPT_mtbm = 1025,                           /* -mtbm */
  OPT_mtls_dialect_ = 1026,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1027,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1028,                         /* -mtune= */
  OPT_mveclibabi_ = 1029,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1030,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1031,                    /* -mvzeroupper */
  OPT_mxop = 1032,                           /* -mxop */
  OPT_n = 1033,                              /* -n */
  ...
  OPT_time = 1103,                           /* -time */
  OPT_time_ = 1104,                          /* -time= */
  OPT_traditional = 1105,                    /* -traditional */
  OPT_traditional_cpp = 1106,                /* -traditional-cpp */
  OPT_trigraphs = 1107,                      /* -trigraphs */
  OPT_u = 1108,                              /* -u */
  OPT_undef = 1109,                          /* -undef */
  OPT_v = 1110,                              /* -v */
  OPT_version = 1111,                        /* -version */
  OPT_w = 1112,                              /* -w */
  OPT_wrapper = 1113,                        /* -wrapper */
  OPT_x = 1114,                              /* -x */
  OPT_z = 1115,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
