...
typedef enum _FLAGS {
	...
	PAGE_USER = 1 << 2, // 0 - supervisor only (kernel), user mode access will cause a fault. 1 - any access (both user mode and kernel mode) is allowed.
} FLAGS;
