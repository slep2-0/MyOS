...
/// <summary>
/// This function checks if the CPUID assembly instruction is available in the current CPU.
/// </summary>
/// <returns>True / False based if present or not.</returns>
...
static inline bool checkApic(void) {
    unsigned int eax, ebx, ecx, edx;
    __cpuid(1, eax, ebx, ecx, edx);
    return edx & (1 << 9); // bit 9 = APIC
}

static inline void getCpuName(char* name) {
    unsigned int regs[4];
    char* p = name;
