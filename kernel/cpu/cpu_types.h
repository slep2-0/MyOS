...
typedef enum _THREAD_STATE { RUNNING, READY, BLOCKED, TERMINATED } THREAD_STATE;
...
typedef enum _IRQL {
    ...
    SYNCH_LEVEL = 29,  // Synchronization level (internal kernel use)
    POWER_LEVEL = 30,  // Power failure interrupts
    HIGH_LEVEL = 31   // NMI and machine‑check (non‑maskable)
} IRQL;
